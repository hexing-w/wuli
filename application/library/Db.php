...
Class Db
{
	...
	public function __construct($db_config)
	{
        ...
        $this->connect($db_config["hostname"], $db_config["username"], $db_config["password"], $db_config["database"],$db_config["port"]);
	...
	//数据库连接
	public function connect($dbhost, $dbuser, $dbpw, $dbname,$port, $charset = 'utf8')
	{

		$this->link = @mysqli_connect($dbhost, $dbuser, $dbpw, $dbname,$port);
